...
class PenghuniRepository ( private val db: AppDatabase) {
    ...
    suspend fun insertPenghuni(penghuniEntity: PenghuniEntity) = db.getPenghuniDao().insertPenghuni(penghuniEntity)
    suspend fun deletePenghuni(penghuniEntity: PenghuniEntity) = db.getPenghuniDao().deletePenghuni(penghuniEntity)
    suspend fun updatePenghuni(penghuniEntity: PenghuniEntity) = db.getPenghuniDao().updatePenghuni(penghuniEntity)
